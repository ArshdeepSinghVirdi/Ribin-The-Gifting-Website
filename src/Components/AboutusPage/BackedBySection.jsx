    ...
    <Stack sx={{ paddingX: "5%", paddingY: "2%", mt: "1rem" }}>
      <Stack direction="column" alignItems="center" position="relative" gap={4}>
        ...
        >
          ...
          >
            Ribin has secured funding from 100X.VC, recognizing our innovative
            approach and potential to revolutionize the gifting industry in
            India. This marks a significant milestone in our journey and
            validates our innovative approach to gifting.
          </Typography>
        </Box>
        <Box
          sx={{
